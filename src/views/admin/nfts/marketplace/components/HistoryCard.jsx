...
const HistoryCard = () => {
  ...
  return (
    <Card extra={"!z-5 overflow-hidden"}>
      {/* HistoryCard Header */}
      <div className="flex items-center justify-between rounded-t-3xl p-4">
      ...
      {HistoryData.map((data, index) => (
        <div className="flex h-full w-full items-center justify-between bg-white px-4 py-[20px] hover:shadow-2xl dark:!bg-navy-800 dark:shadow-none dark:hover:!bg-navy-700">
