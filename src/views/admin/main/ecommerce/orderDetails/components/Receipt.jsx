  ...
  return (
    <Card extra={"w-full h-full px-6 py-6"}>
      ...
      <div
        ...
        className="flex w-full items-center justify-between rounded-2xl bg-cover bg-no-repeat px-6 pb-10 pt-11 md:!h-[180px] md:items-start md:pl-[50px] md:pr-[57px] 2xl:!h-[190px]"
      >
        <div className="">
