...
const Banner = () => {
  return (
    <div className="mx-auto rounded-2xl bg-gradient-to-br from-brandLinear to-blueSecondary px-4 pt-9 pb-[140px] font-dm md:w-[90%] md:pb-[70px] lg:h-[315px] lg:!px-[50px] lg:pt-[70px] xl:!px-[50px] 3xl:w-full">
      {/* Header */}
      <div className="mb-3 flex justify-between">
        <div className="flex h-7 w-[110px] items-center justify-center rounded-[10px] bg-brandLinear text-sm font-bold text-white">
          PAID INVOICE
        </div>
      ...
      <div className="flex flex-col md:flex-row">
        <div className="mb-[24px]">
          <h1 className="text-xl font-bold text-white md:text-3xl lg:text-[45px]">
            Invoice #03941
          </h1>
